...
import com.example.marveluniverse.BitmapHunter;
import com.example.marveluniverse.HUNTER_BATCH_COMPLETE;
import com.example.marveluniverse.REQUEST_GCED;
    ...
    static final Handler HANDLER = new Handler(Looper.getMainLooper()) {
        @Override public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case REQUEST_GCED: {
                    Notification.Action action = (Notification.Action) msg.obj;
